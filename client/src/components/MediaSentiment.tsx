      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Media Sentiment Tracking</CardTitle>
          </div>
          <Button
            variant="outline"
            size="sm"
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Monitor news coverage and public sentiment about coalition possibilities
        </p>
      </CardHeader>
        ...
        {selectedParties.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Select parties in the Coalition Builder to see media sentiment analysis
            </p>
          </div>
        ) : currentSentiment ? (
