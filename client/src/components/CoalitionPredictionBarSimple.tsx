...
export default function CoalitionPredictionBarSimple() {
  ...
  return (
    <Card className="bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 sticky top-4 z-40">
      <div className="p-4">
        ...
        <div className="relative h-12 bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
          ...
          {selectedPartiesData.reduce((acc, party, index) => {
            const previousSeats = selectedPartiesData.slice(0, index).reduce((sum, p) => sum + p.predictedSeats, 0);
