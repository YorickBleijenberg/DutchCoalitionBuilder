    ...
    <div className="min-h-screen coalition-background coalition-text transition-colors duration-300">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium">
                {(() => {
                  ...
                  return diffDays > 0
                    ? `Dagen tot de verkiezingen: ${diffDays}`
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-8 w-8 p-0 text-white hover:bg-blue-700 dark:hover:bg-blue-700"
                  >
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem
                    ...
                    className={
                      language === "nl" ? "bg-gray-100 dark:bg-gray-700" : ""
                    }
                  >
                    🇳🇱 Nederlands
                  </DropdownMenuItem>
      ...
      <main className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20 md:pb-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent
            value="predictions"
            className="space-y-8 bg-blue-50/30 dark:bg-blue-900/10 rounded-lg p-6"
          >
          ...
          <TabsContent
            value="coalitions"
            className="space-y-8 bg-green-50/30 dark:bg-green-900/10 rounded-lg p-6"
          >
          ...
          <TabsContent
            value="export"
            className="space-y-8 bg-orange-50/30 dark:bg-orange-900/10 rounded-lg p-6"
          >
            <PoliticalPredictor />
          </TabsContent>
          ...
          <TabsContent
            value="analytics"
            className="space-y-8 bg-purple-50/30 dark:bg-purple-900/10 rounded-lg p-6"
          >
            <CoalitionTimeline />
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <SwingAnalysis />
